  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ fontSize: '1.8rem', fontWeight: '800', color: '#1e3a5f', margin: '0 0 8px' }}>
          Planet Ordnung
        </h1>
        <p style={{ color: '#64748b', marginBottom: '32px', fontSize: '0.95rem' }}>
          Ordentlich. Organisiert. Mit Herz.
        </p>

        {error && (
          <div style={{
            background: '#fef2f2', color: '#dc2626', borderRadius: '8px',
            padding: '12px', marginBottom: '16px', fontSize: '0.85rem'
          }}>
            {error}
          </div>
        )}
        ...
        <p style={{ marginTop: '24px', fontSize: '0.75rem', color: '#94a3b8' }}>
